    ...
    >
      ...
      <ul className="list-unstyled">
        {menuItems.map((item, index) => {
          ...
          return (
            <button style={{
              all: "unset",     // Optional: add some spacing
              cursor: "pointer",
              display: "block",
              width: "100vw",
              paddingLeft: "16px"
            ...
            >
              ...
              {isIcon && (
                <>
                  ...
                  <span 
                    className="badge text-light ms-auto px-2 py-1" 
                    style={{ fontSize: '0.7rem', backgroundColor: "#C6B1DE", borderRadius: "2px" }}
                  >
                    {item.beta}
                  </span>
                </>
...
//   return (
//     <div
//       className="bg-[#FFFFFF] border-end d-flex flex-column p-3"
//       style={{
//         width: isIcon ? '210px' : '60px',
//         minWidth: isIcon ? '210px' : '60px',
//         height: '100vh',
...
//                 <hr style={{ color: "gray", width: "100%", marginLeft: 0 }} />
//                 <p
//                   className="fw-bold mt-3 mb-2"
//                   style={{
//                     fontSize: isIcon ? '1rem' : 0,
